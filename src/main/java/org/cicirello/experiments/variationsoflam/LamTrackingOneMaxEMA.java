...
import org.cicirello.search.sa.SelfTuningModifiedLam_EMAWindowVariable;
import org.cicirello.search.sa.SimulatedAnnealing;
import org.cicirello.search.sa.SelfTuningModifiedLam_EMAWindowConstant;
...
public class LamTrackingOneMaxEMA {
	...
	public static void main(String[] args) {
		...
		AcceptanceTracker modifiedLam = new AcceptanceTracker(new SelfTuningModifiedLam_EMAWindowVariable());
		AcceptanceTracker selfTuningLam = new AcceptanceTracker(new SelfTuningModifiedLam_EMAWindowConstant());
		...
		System.out.println("VarEMA\tConstEMA");
