 ...
 * @version 1.22.2021
 */
public final class SelfTuningModifiedLam_EMAWindowConstant implements AnnealingSchedule {
	 ...
	 * the constructor.
	 */
	public SelfTuningModifiedLam_EMAWindowConstant() {
		lastMaxEvals = -1;
	}
	...
	@Override
	public SelfTuningModifiedLam_EMAWindowConstant split() {
		return new SelfTuningModifiedLam_EMAWindowConstant();
	}
