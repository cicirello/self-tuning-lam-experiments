 ...
 * @version 1.22.2021
 */
public final class SelfTuningModifiedLam_EMAWindowVariable implements AnnealingSchedule {
	 ...
	 * the constructor.
	 */
	public SelfTuningModifiedLam_EMAWindowVariable() {
		lastMaxEvals = -1;
	}
	...
	@Override
	public SelfTuningModifiedLam_EMAWindowVariable split() {
		return new SelfTuningModifiedLam_EMAWindowVariable();
	}
